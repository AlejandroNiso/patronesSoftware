...
/**
 * Clase que representa un producto pesado en la aplicación
...
public class ProductoPesado extends Producto{
    ...
    /**
     * Constructor de la clase ProductoPesado
     * @param idProducto -> id del producto
     * @param nombre -> nombre del producto
     * @param precio -> precio del producto
     * @param descripcion -> descripción del producto.
     * En este tipo de Producto, la descripción se establece en "Pesado"
     */
