...
import almacen.Strategy.BusquedaID;
import almacen.Strategy.BusquedaNombre;
import almacen.DarBaja;
import almacen.FactoryMethod.AltaPersona;
import almacen.Strategy.OrdenaID;
import almacen.Strategy.OrdenaNombre;
import java.sql.SQLException;
import java.util.logging.Level;
import java.util.logging.Logger;

/**
 * Clase MenuProveedores que contiene la interfaz para las posibles gestiones sobre los proveedores
 * @author alexc
 */
public class MenuProveedores extends javax.swing.JFrame {
    
    // Atributo de la clase, el tipo de Persona, que es 1 al tratarse de un proveedor
    private int tipo = 1;
    /**
     * Constructor de MenuProveedores
     */
    ...
    private void button2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button2ActionPerformed
        // TODO add your handling code here:
        DarBaja baja = new DarBaja("Proveedor");
     ...
     * En caso de que se haya seleccionado id, se ordena por id la tabla Proveedor de la BD
     * En caso contrario, se habrá seleccionado Nombre por lo que se ordenará por nombre la tabla Proveedor de la BD
     */
    
    private void button3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button3ActionPerformed
        // TODO add your handling code here:
        if(choice1.getSelectedItem()=="Id"){
            OrdenaID ordena = new OrdenaID("Proveedor");
            ordena.setVisible(true);
            try {
                ordena.ordenar("Proveedor");
            ...
            OrdenaNombre ordena = new OrdenaNombre("Proveedor");
            ordena.setVisible(true);
            try {
                ordena.ordenar("Proveedor");
            } catch (SQLException ex) {
     ...
     * En caso de que se haya seleccionado id, se buscará por id la tabla Proveedor de la BD
     * En caso contrario, se habrá seleccionado Nombre por lo que se buscará por nombre la tabla Proveedor de la BD
     */
    
    private void button4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_button4ActionPerformed
        // TODO add your handling code here:
        if(choice2.getSelectedItem()=="Id"){
            BusquedaID busqueda = new BusquedaID("Proveedor");
            busqueda.setVisible(true);
            this.dispose();
        
        }else{
            BusquedaNombre busqueda = new BusquedaNombre("Proveedor");
            busqueda.setVisible(true);
            this.dispose();
        }
